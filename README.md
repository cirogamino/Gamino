...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/rental-1#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/rental-1
```

A live public deployment of this template is available at [https://rental-1.templates.workers.dev](https://rental-1.templates.workers.dev)
